...
<?php
require_once 'dp3.php';

$message = "";
$message_color = "red"; // اللون الافتراضي
...
<head>
<meta charset="UTF-8">
<title>نظام تحويل الأموال لثلاثة أشخاص</title>
<style>
...
<body>
<div class="container">
<h2>نظام تحويل الأموال لثلاثة أشخاص</h2>
...
<h2>الحسابات</h2>
<table>
<tr><th>اسم الحساب</th><th>الرصيد</th></tr>
<?php foreach($accounts as $acc): ?>
<tr><td><?= $acc['name'] ?></td><td><?= $acc['balance'] ?></td></tr>
<?php endforeach; ?>
</table>
...
<tr><td><?= $t['source_name'] ?></td><td><?= $t['target_name'] ?></td><td><?= $t['amount'] ?></td><td><?= $t['transaction_date'] ?></td></tr>
<?php endforeach; ?>
</table>
</div>
</body>
